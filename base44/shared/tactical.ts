...
export const UPGRADES = {
  armor_skirts:     { key: 'armor_skirts',     label: 'Armor Skirts',      appliesTo: ['crawler', 'autocar_scouts', 'land_dreadnought'], pts: 24, tier: 'I', mods: { armor: 3, speed: -1 }, blurb: "Bolted plate hung off the running gear against a shaped charge walking up to the track. The hull gains a course of armour and loses the last of its pace." },
  ...
  drum_magazines:   { key: 'drum_magazines',   label: 'Drum Magazines',    appliesTo: ['assault', 'stormtroops', 'gunners', 'provost', 'autocar_scouts'], pts: 18, tier: 'I', mods: { ranged: 3, range: -1 }, blurb: "Drums in place of sticks, and a great deal more going out per minute. It is short work, badly aimed, and it wins rooms." },
