...
> Lane H **reported the conflict rather than writing** (the §3-wins rule), and the orchestrator answered by re-issuing the instruction. This amendment is the record of that answer, filed the way Lane F's Amendment 1 and Lane G's Amendment 3 filed theirs — the plan's own mechanism for a lane claiming a path §3 did not assign it.
