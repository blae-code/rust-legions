...
This is **Rust Legions**, a turn-based dieselpunk strategy game built as a Base44 app. Treat it as user-owned application code, keep changes focused on the user's request, and preserve existing project conventions.
