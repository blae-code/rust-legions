// ---------------------------------------------------------------------------
// THE ARMS CATALOGUE — frontend mirror of base44/shared/arms.ts.
//
...
// no UI-only allowlist here, unlike src/lib/tactical/data.js, because label,
// blurb and lore are already canonical on the server side. Both halves are
// enforced by test/arms-mirror.test.js: the tables deep-equal, the exported
// identifier sets are equal, and each function's source text matches.
//
// Imports nothing, by design: base44/shared/* never imports from src/, and
// src/lib/* never imports from base44/, so the mirror is a copy and the test
