...
import QuickSaveButton from "@/components/skirmish/QuickSaveButton";
...
export default function BattleBanner({ order, onStand, onQuickSave }) {
  return (
    <div className="cq-slip px-3 py-2 flex flex-wrap items-center gap-3">
      ...
      <QuickSaveButton onSave={onQuickSave} savedAt={order.snapshot?.savedAt} />
      <Link
        to="/skirmish"
        onClick={onStand}
        title="End this skirmish and discard its session save"
