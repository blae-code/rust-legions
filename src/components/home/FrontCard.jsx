...
export default function FrontCard({ game, index }) {
  ...
  return (
    ...
    >
      <Link to={`/game/${game.id}`} className="cq-panel cq-brackets block p-3.5 hover:border-brass/60 hover:-translate-y-0.5 transition-all group">
        ...
        <h3 className="font-heading font-semibold text-base tracking-wide text-foreground group-hover:text-brass-bright transition-colors">
          {game.name}
        </h3>
        ...
        <div className="flex items-center gap-1 mt-1.5 text-[9px] font-heading uppercase tracking-[0.2em] text-brass/70 group-hover:text-brass-bright transition-colors">
